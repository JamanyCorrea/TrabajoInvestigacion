...
function MostrarModal() {
    ...
    btnclick.addEventListener('click', (event) => {
        ...
        if (camposvacios === false && datosvalidos === true) {
            ...
            document.getElementById('saludos').innerHTML = `<img class='estrella' src="./img/1.png" alt="" />
            <strong style="font-size: 1rem;">Gracias por su inscripcion, le saluda Jazmany Correa</strong><p>${nombre} revise su correo => ${email} para confirmar su registro, gracias por su comentario => ${comentario}</p> <span id="closex" class="close">Aceptar</span>`
